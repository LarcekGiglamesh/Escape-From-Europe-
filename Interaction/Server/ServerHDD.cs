...
public class ServerHDD : MonoBehaviour, IServerCollision
{
  public GameObject m_lookAt = null;
  private GameObject m_hddObject = null;
  ...
  void Start()
  {
    ...
    ccd.ListenOnCollision(StringManager.Tags.ServerHdd, CustomOnTriggerEnter, CustomOnTriggerExit);
  }
