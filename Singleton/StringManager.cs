...
public class StringManager : MonoBehaviour
{
  ...
  public class Tags
  {
    ...
    public const string ServerCoolingElement = "ServerCoolingElement";
    public const string ServerHdd = "ServerHdd";
    public const string ServerCpu = "ServerCpu";
  ...
  public class Layer
  {
    ...
    public const string ServerDoor = "ServerDoor";
    public const string ServerDoorEnd = "ServerDoorEnd";
  }
}
